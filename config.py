...
class Config:
    ...
    DATABASE_PATH = 'postgresql://vapecloud_main_db_user:E4QCIJPq0mugsqYV1THEcnjFXGjKWtbX@dpg-d5dpe0ogjchc73dr9rj0-a.oregon-postgres.render.com:5432/vapecloud_main_db'
